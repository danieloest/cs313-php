...
<body>
    ...
    // If we have stuff in our cart
        ...
        if(isset($_SESSION["Krazy Kitty"])) {
            echo "<tr><td>" . $_SESSION["Krazy Kitty"]->name . "</td><td><div class=\"flex-container\"><input class=\"inputNum\" type=\"number\" value=\"" . $_SESSION["Krazy Kitty"]->quantity . "\" id=\"kkQuantity\"><button onclick=\"update(kkQuantity.value, kk)\">✔</button></div></td><td><a href=\"cart.php?remove=PP\">❌</a></td><td>$" . $_SESSION["Krazy Kitty"]->price . "</td></tr>";
